# AstroBox-NG-Module-Bluetooth

此项目为AstroBox协蓝牙连接模块，用于与穿戴设备进行蓝牙通信/配对，此库使用 AGPL 3.0 授权

This project is the AstroBox Bluetooth connection module, used for Bluetooth communication/pairing with wearable devices. This library is licensed under AGPL 3.0.
